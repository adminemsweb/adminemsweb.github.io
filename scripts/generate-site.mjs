...
const contact = 'https://wa.me/5511921047460?text=' + encodeURIComponent('Olá! Gostaria de conversar sobre um projeto com a Metall Rack.');
const lineInfo = {
...
const cta = () => `<section class="project-cta container"><div><p class="eyebrow">VAMOS CONVERSAR?</p><h2>Seu próximo projeto<br>começa por uma boa estrutura.</h2></div><a class="button" href="${contact}" target="_blank" rel="noopener noreferrer">${whatsapp}Falar com a Metall Rack</a></section>`;
...
function writePage(route, title, description, content, bodyClass='') {
  ...
  $('title').text(route === '/' ? 'Metall Rack' : `${title} | Metall Rack`);
...
writePage('/', 'Racks, gabinetes e infraestrutura', 'Conheça as linhas de racks, gabinetes, acessórios e fibra da Metall Rack. Encontre produtos e solicite um orçamento para o seu projeto.', `
